...
def badgeNameByUID(uid):
    for k, v in ClientBadges.items():
        if v == uid: return k

def badgeUIDByName(name):
    for k, v in ClientBadges.items():
        if k == name: return k
...
Badges = {
    "1cb07348-34a4-4741-b50f-c41e584370f7": {
        "name": "TeamSpeak Addon Author",
        "description": "Creator of TeamSpeak Addons",
        "filename": "addon_author" },
    "450f81c1-ab41-4211-a338-222fa94ed157": {
        "name": "TeamSpeak Addon Developer (Bronze)",
        "description": "Creator of at least 1 TeamSpeak Addon",
        "filename": "addon_author_bronze" },
    "c9e97536-5a2d-4c8e-a135-af404587a472": {
        "name": "TeamSpeak Addon Developer (Silver)",
        "description": "Creator of at least 3 TeamSpeak Addons",
        "filename": "addon_author_silver" },
    "94ec66de-5940-4e38-b002-970df0cf6c94": {
        "name": "TeamSpeak Addon Developer (Gold)",
        "description": "Creator of at least 5 TeamSpeak Addons",
        "filename": "addon_author_gold" },
    "62444179-0d99-42ba-a45c-c6b1557d079a": {
        "name": "Gamescom 2014",
        "description": "Registered at Gamescom 2014",
        "filename": "gamescom_2014" },
    "50bbdbc8-0f2a-46eb-9808-602225b49627": {
        "name": "Gamescom 2016",
        "description": "Registered during Gamescom 2016",
        "filename": "gamescom_2016" },
    "534c9582-ab02-4267-aec6-2d94361daa2a": {
        "name": "Gamescom 2017",
        "description": "Visited TeamSpeak at Gamescom 2017",
        "filename": "gamescom_2017",
        "codes": ["DK9JGRJH1Q"] },
    "34dbfa8f-bd27-494c-aa08-a312fc0bb240": {
        "name": "Gamescom Hero 2017",
        "description": "Gaming Hero at Gamescom 2017",
        "filename": "hero_2017" },
    "7d9fa2b1-b6fa-47ad-9838-c239a4ddd116": {
        "name": "MIFCOM",
        "description": "MIFCOM | Entered Performance",
        "filename": "mifcom" },
    "d95f9901-c42d-4bac-8849-7164fd9e2310": {
        "name": "Paris Games Week 2016",
        "description": "Registered during Paris Games Week 2016",
        "filename": "paris_gamesweek_2016" },
    "f81ad44d-e931-47d1-a3ef-5fd160217cf8": {
        "name": "4Netplayers",
        "description": "4Netplayers customer",
        "filename": "4netplayers" },
    "f22c22f1-8e2d-4d99-8de9-f352dc26ac5b": {
        "name": "Rocket Beans TV",
        "description": "Rocket Beans TV Community",
        "filename": "rbtv",
        "codes": ["RWGE2NURJZ"] }
}
