...
"""
    ...
    def processCommand(self, schid, cmd):
        ...
        if command == "nick": self.onConnectStatusChangeEvent(schid, ts3defines.ConnectStatus.STATUS_CONNECTION_ESTABLISHED, 0); return True
            ...
            print("suid:", self.suid)
            print("channelAdminGroupID:", self.channelAdminGroupID)
            print("premiumGroupIDs:", self.premiumGroupIDs)
            print("ruheGroupID:", self.ruheGroupID)
            print("gommeBotNick:", self.gommeBotNick)
            print("dynamicSilenceName:", self.dynamicSilenceName)
            print("delay:", self.delay)
            print("nick_enabled:", self.nick_enabled)
            print("nicknames:", self.nicknames)
            print("settings:", self.settings)
            print("violations:", self.violations)
            print("askForAvatar:", self.askForAvatar)
            print("dynamicSilence:", self.dynamicSilence)
            print("alreadyAsked:", self.alreadyAsked)
            print("schid:", self.schid)
            print("clids:", self.clids)
            print("dynamicSilenceCache:", self.dynamicSilenceCache)
            print("gommeBotID:", self.gommeBotID)
            print("timer:", self.timer)
            print("aka:", self.aka)
            print("msg:", self.msg)
            print("blockMSG:", self.blockMSG)
            print("successMSG:", self.successMSG)
            print("ignoreMSG:", self.ignoreMSG)
            print("agreeMSG:", self.agreeMSG)
            print("steammsg:", self.steammsg)
            print("avatarmsg:", self.avatarmsg)
            return True